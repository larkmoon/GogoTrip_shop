...
public class ProductBiz implements Biz<Integer, ProductVO> {
	...
	public List<ProductVO> getbyupcate(int upid) throws Exception{
		return dao.selectbyupcate(upid);
	}
	
	public List<ProductVO> getbycate(int cid) throws Exception{
		return dao.selectbycate(cid);
	}
